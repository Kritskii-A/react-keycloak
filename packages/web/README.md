...
```js
import { useKeycloak } from '@easy-react-keycloak/web'
...
See inside `examples` folder of [`@easy-react-keycloak/react-keycloak-examples`](https://github.com/react-keycloak/react-keycloak-examples) repository for various demo implementing this library main features.

## Guides and Articles

- Migration guide for `@easy-react-keycloak/web` `v2.x to v3.x` can be found here [MIGRATION.md](https://github.com/react-keycloak/react-keycloak/blob/master/packages/web/MIGRATION.md).
